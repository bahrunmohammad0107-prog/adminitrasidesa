...
AND pajak_sppt.status='SUDAH BAYAR'
...
<td class="text-center">
<?= !empty($d['tanggal_bayar']) ? date('d-m-Y',strtotime($d['tanggal_bayar'])) : '-' ?>
</td>
